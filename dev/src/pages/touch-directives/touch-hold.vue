<template>
  <div class="q-layout-padding docs-touch row justify-center">
    <div style="width: 500px; max-width: 90vw;">
      ...
      <button @click="disable=false" label="Directive disabled">禁用</button>
      <button @click="disable=true" label="Directive disabled">启用</button>
      <div
      ...
      >
        <div @touchstart="handleEvt" @mousedown="handleEvt" style="padding: 24px" class="cursor-pointer bg-primary text-white rounded-borders shadow-2">
          <div>
            <button @click="holdTestStopPropagation = false">禁用 propagation</button>
            <button @click="holdTestStopPropagation = true">启用 propagation</button>
          </div>
